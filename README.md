...
> Forked from https://github.com/hyperia-sk/yii2-secure-headers
...
```shell
composer require ujvilag/yii2-secure-headers:"^1.0"
```

or add

```
"ujvilag/yii2-secure-headers": "^1.0"
```
...
'components' => [
    ...
    'headers' => [
        'class' => '\ujvilag\security\Headers',
